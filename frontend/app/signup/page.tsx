...
function SignupForm() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If access token is returned, user is automatically logged in
  ...
  return (
    <div className="min-h-screen flex" style={{
      ...
      {/* Left Side - Image */}
      <div className="hidden lg:flex lg:w-7/12 xl:w-8/12 items-center justify-center p-8 relative">
      ...
      <div className="w-full lg:w-5/12 xl:w-4/12 flex items-center justify-center p-4 bg-white overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <div className="mb-6">
            <p className="text-sm text-gray-600 mb-3 text-center">Sign up with</p>
